...
resource "aws_security_group_rule" "db_vpn" {
  ...
  to_port           = 3306
  protocol          = "tcp"
  source_security_group_id = module.vpn.sg_id # Source where getting traffic
  security_group_id = module.db.sg_id
    
  }

#BAcnkend accepting from ALB
resource "aws_security_group_rule" "backend_app_alb" {
  type              = "ingress"
  from_port         = 8080
  to_port           = 8080
  protocol          = "tcp"
  source_security_group_id = module.app_alb.sg_id # Source where getting traffic
